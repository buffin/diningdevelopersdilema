INSERT INTO  users (name, username, email, password) VALUES ('Nils', 'neckert', 'mail@nils-eckert.de', SHA1( 'neckert'));
INSERT INTO  users (name, username, email, password) VALUES ('Benjamin', 'basbach', 'mail@nils-eckert.de', SHA1( 'basbach'));
INSERT INTO  users (name, username, email, password) VALUES ('Markus', 'mfischer', 'mail@nils-eckert.de', SHA1( 'mfischer'));
INSERT INTO  users (name, username, email, password) VALUES ('Michel', 'mzedler', 'mail@nils-eckert.de', SHA1( 'mzedler'));
INSERT INTO  users (name, username, email, password) VALUES ('Jens', 'jmertz', 'mail@nils-eckert.de', SHA1( 'jmertz'));
INSERT INTO  users (name, username, email, password) VALUES ('Phil', 'pmeier', 'mail@nils-eckert.de', SHA1( 'pmeier'));
INSERT INTO  users (name, username, email, password) VALUES ('Timo', 'tguenzel', 'mail@nils-eckert.de', SHA1( 'tguenzel'));
